(function () {
    ...
    function doSearch(value) {
        ...
        matchs.forEach(function (post) {
            ...
            if (window.location.href.indexOf(".html")>-1 && post.url.indexOf(".html")<0){
                post.url = post.url.slice(0,post.url.indexOf('?')) + '.html' +post.url.slice(post.url.indexOf('?'))
            }
            let domain = window.location.href.slice(0,window.location.href.indexOf(window.location.pathname))
            post.url = post.url.replace(domain,'').replace("//",'/')
